...
namespace OP
{
    public class CameraHandler : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            ignoreLayers = ~(1 << 8 | 1 << 9 | 1 << 10); // ! Don't know What this is.
        }
        ...
        public void HandleCameraRotation(float delta, float mouseXInput, float mouseYInput)
        {
            ...
            Vector3 pivot_rotation = Vector3.zero;
            pivot_rotation.x = pivotAngle;
            Quaternion pivotTargetRotation = Quaternion.Euler(pivot_rotation);
